 ...
 * @example  <base-popup-dialog :nodeId="familyListData.nodeId"	footerType="custom" type="bottom" :maskClick="true" :showClose="true" class="see-dialog-container"></base-popup-dialog>
  */
